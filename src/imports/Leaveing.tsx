    ...
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[2px] items-center not-italic p-[16px] relative text-[#f3eadf] text-center w-full">
          <p className="font-['SF_Pro_Text:Semibold',sans-serif] leading-[22px] relative shrink-0 text-[17px] tracking-[-0.408px] w-full">Вы покидаете страницу</p>
          <p className="font-['SF_Pro_Text:Regular',sans-serif] leading-[18px] relative shrink-0 text-[13px] tracking-[-0.078px] w-full">Эта запись не будет сохранена</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[41px] py-[11px] relative size-full">
          <div className="flex flex-col font-['SF_Pro_Text:Semibold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ffc90c] text-[17px] text-center text-nowrap tracking-[-0.408px]">
            <p className="leading-[22px]">Выйти</p>
          </div>
        </div>
      </div>
    </div>
...
export default function Leaveing() {
  return (
    <div className="bg-black content-stretch flex flex-col items-start relative size-full" data-name="Leaveing">
      <AlertTemplate />
    </div>
  );
}